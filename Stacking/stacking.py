...
def get_stack(galaxy,prior_lines,lines, dir_save, dir_data ='./../../data/Database/', show = False, do_smooth = False, xtype = None, naming_convention = "_database.idl", sn_limits = [2,4], no_detec_wdw = 30, pad_v = 100):
    """
